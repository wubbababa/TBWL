...
export default function ProductDatabasePage() {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    let query = supabase.from('inventory_products').select('id, store_name, sku, name, thumbnail, created_at');
          ...
          <table className="w-full text-sm text-center">
            <thead className="bg-white border-y border-gray-200 text-gray-700 font-bold">
              <tr>
                ...
                <th className="px-4 py-3 whitespace-nowrap">店铺</th>
                ...
                <th className="px-4 py-3 whitespace-nowrap">记录时间</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
